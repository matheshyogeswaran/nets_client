...
//         updateRemainingTime(timeLimitInSeconds);
//       })
//       .catch((error) => {
//         console.log(error);
//       });
...
//   const updateRemainingTime = (timeLimitInSeconds) => {
...
//     const attemptedTime = moment(endTime - (timeLimitInSeconds - remainingTimeInSeconds) * 1000).format('YYYY-MM-DD hh:mm:ss A'); // Calculate the attempted time and format it
